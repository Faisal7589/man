...
export default function StandardEffects({ smaa = true, ao = true, bloom = true, edgeDetection = 0.1, bloomOpacity = 1, effects }) {
  ...
  const composer = useMemo(() => {
    ...
    return composer
  }, [gl, scene, camera, smaaProps, edgeDetection, bloom, bloomOpacity, effects, smaa])
